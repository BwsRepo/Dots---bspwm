...
box_attrs=':orientation "h" :class "workspaces" :space-evenly true :halign "center" :valign "center" :expand true '

eww update workspaces_1_yuck="(box $box_attrs $(gib_workspace_yuck 1))"
#eww -c ~/.config/eww.yuck update workspaces_2_yuck="(box $box_attrs $(gib_workspace_yuck 2))"
